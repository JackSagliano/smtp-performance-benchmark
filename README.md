...
Tool progettato per eseguire benchmark prestazionali su servizi SMTP. Esso consiste nell'inviare N messaggi ad un servizio SMTP per calcolarne i tempi minimi, massimi e medi di recezione, sulla base di fattori come il numero di messaggi inviati e la grandezza (in byte) del corpo del messaggio.
